...
def run_FedCS(env_cfg, glob_model, cm_map, data_size, fed_loader_train, fed_loader_test, client_shard_sizes,
    ...
    for rd in range(env_cfg.n_rounds):
        ...
        selected_ids = FedCS_selection(selected_ids, env_cfg.bw_s_set, env_cfg.model_size, clients_est_round_T_train,
    ...
    sync_ratio = sync_ratio / (
                env_cfg.pick_pct + 0.1) * env_cfg.pick_pct if sync_ratio > env_cfg.pick_pct else sync_ratio
    print('> SR:', sync_ratio)
    ...
    utils.log_stats('../stats/FedCs_svm.txt', env_cfg, detail_env, time_trace, epoch_train_trace, epoch_test_trace,
